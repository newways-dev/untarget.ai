  ...
  return (
    <div className={styles.discounts}>
      <div className={styles.discount}>
        ...
        <div className={styles.wrapper}>
          <p>
            ...
            получите 5% скидку на защиту этого сайта.
          </p>
      ...
      <div className={styles.program}>
        ...
        <ul>
          <li>
            Агентское вознаграждение - 30% от затрат на проверку рекламного
            трафика сайтов, подключенных по партнёрской ссылке.
          </li>
          <li>
            Срок действия - бессрочно (пока клиент оплачивает услуги сервиса вы
            получаете агентское вознаграждение).
          </li>
          <li>
      ...
      <div className={styles.tinkoff}>
        ...
        <p>
          ...
          дополнительные 2 месяца бесплатной защиты от скликивания рекламы.
        </p>
      ...
      <div className={styles.bonus}>
        ...
        <p>
          Получите <strong>5000 ₽</strong> на баланс за публикацию статьи об
          опыте использованиия сервиса в борьбе со скликиванием рекламы.{' '}
        </p>
      </div>
    </div>
  )
